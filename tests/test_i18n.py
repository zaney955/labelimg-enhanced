...
from labelimg.constants import SETTING_LANGUAGE
...
class TranslationCatalogTest(unittest.TestCase):
    ...
    def test_first_launch_uses_system_locale_mapping(self):
        with patch("labelimg.i18n.locale.getlocale", return_value=("zh_TW", "UTF-8")):
            self.assertEqual(system_language(), SIMPLIFIED_CHINESE)
        with patch("labelimg.i18n.locale.getlocale", return_value=("ja_JP", "UTF-8")):
