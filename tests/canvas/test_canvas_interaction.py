...
class CanvasInteractionTest(unittest.TestCase):
    ...
    def test_ordinary_target_ignores_label_text_and_uses_geometry(self):
        class FakeShape:
        ...
        self.assertIs(target.shape, geometry_shape)
        self.assertEqual(target.vertex, 0)
    ...
    def test_label_overlap_uses_containment_distance_and_layer_order(self):
        ...
        target = self.interaction.resolve_label_target(
            (inner, outer),
            QPointF(20, 10),
