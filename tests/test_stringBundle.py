...
class TestStringBundle(unittest.TestCase):
    ...
    def test_loadDefaultBundle_withoutError(self):
        ...
        self.assertEqual(str_bundle.get_string("openDir"), 'Open Directory', 'Fail to load the default bundle')

    def test_fallback_withoutError(self):
        str_bundle = StringBundle.get_bundle('zh-TW')
        self.assertEqual(str_bundle.get_string("openDir"), '打开目录', 'All Chinese locales use Simplified Chinese')
